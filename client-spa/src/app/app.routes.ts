...
export const routes: Routes = [
  { path: '', redirectTo: 'en/home', pathMatch: 'full' }, // Redirect root to 'home' with default language
  {
    ...
    children: [
      ...
      { path: 'tools', component: ToolsComponent, data: { title: 'Tools - Moubien Kayali', description: 'Useful tools for conversion and formatting', keywords: 'tools, converter, PDF' }}
    ]
  },
  {
    path: 'ar',
